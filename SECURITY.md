...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-file-progress-2/security/advisories/new>
...
- Keep `eslint-plugin-file-progress-2`, ESLint, TypeScript, and dependencies updated.
