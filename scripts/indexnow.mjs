 ...
 * }}
 *
 * @throws {Error} When unexpected or malformed CLI arguments are provided.
 */
 ...
 * @returns {string}
 *
 * @throws {Error} When neither CLI option nor environment variable provides a
 *   value.
 */
 ...
 *
 * @throws {Error} When the value is not a JSON array of non-empty strings.
 */
 ...
 * @returns {string}
 *
 * @throws {Error} When the key does not match the IndexNow format constraints.
 */
 ...
 *
 * @throws {Error} When the key file name is empty after trimming.
 */
 ...
 *
 * @throws {Error} When no valid `&lt;loc&gt;` entries are found.
 */
